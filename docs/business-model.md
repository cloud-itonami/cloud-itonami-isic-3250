# Business Model: Manufacture of medical and dental instruments and supplies
...
## Classification
- Repository: `cloud-itonami-isic-3250` ([github.com/cloud-itonami/cloud-itonami-isic-3250](https://github.com/cloud-itonami/cloud-itonami-isic-3250))
- ISIC Rev.5: `3250` — Manufacture of medical and dental instruments and supplies
- Domain: `:medical-dental-instrument/manufacturing`
- Social impact: :patient-safety :worker-safety :materials-safety
- Actor: `:medical-instrument-plant-operations-governor` — an independent Governor in the fleet's Sealed-LLM
...
## Customer
An operator running this vertical as an OSS business — :medical-dental-instrument/manufacturing — who wants
...
One managed tenant (:medical-dental-instrument/manufacturing):
...
- Do not bypass the `:medical-instrument-plant-operations-governor` for production decisions.
