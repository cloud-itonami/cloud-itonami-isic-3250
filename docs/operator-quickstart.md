# Operator Quickstart — Manufacture of medical and dental instruments and supplies

Shortest path from clone to a verified local dry-run for **ISIC 3250** (`cloud-itonami-isic-3250`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-3250.git
cd cloud-itonami-isic-3250
```
...
- Blueprint governor key: `medical-instrument-plant-operations-governor`
- Likely source path: `medinstrmfg.governor.cljc`
