(ns medinstrmfg.phase
  "Phase 0->3 staged rollout for the medical-and-dental-instrument
  ...
  consequence (a machining/molding/sterilization-equipment maintenance
  window means production downtime, and the equipment ends up actually
  touched); it is always a human plant supervisor's call.
  `medinstrmfg.governor`'s `actuate-equipment-blocked-violations`
...
(defn verdict->disposition
  "Map a Medical Instrument Plant Operations Governor verdict to a
